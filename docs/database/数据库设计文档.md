...
为事故车维修平台（辙见）提供完整的数据存储方案，支撑 AI 定损、竞价报价、订单、评价、奖励金等核心业务。评价与激励体系、核心算法以《全指标底层逻辑梳理.md》为准。
...
**rewardRules JSON 结构**：complexityLevels（数组，每项 level/project_type/fixed_reward/float_ratio/cap_amount）、vehicleTierLowMax、orderTier1Max 等。
