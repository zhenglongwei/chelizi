...
| 步骤 | 触发 | 数据变更 | 校验 |
|------|------|----------|------|
| 1 | 服务商提交报价 | INSERT quotes (quote_status=0, quote_valid_until=NOW+quote_validity_days) | 竞价 status=0；本店未报价；本店在范围内；资质已通过 |
...
| 2 | 服务商可见性 | 待报价 Tab 通过 expire_at > NOW() 过滤，过期竞价不再展示给服务商 |
