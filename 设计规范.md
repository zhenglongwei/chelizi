...
**设计令牌与组件类**：`styles/design-system.wxss`（含历史 `--warranty-`* 色板，新页面一般不再使用）

**历史（已停用入口）**：`styles/warranty-card-themes.wxss`、`components/warranty-card-surface` 曾为电子质保卡卡面；产品上以订单分项质保为准后，**勿在新功能中引用**。
...
| --primary-bg          | rgba(37,99,235,0.1)  | 主色浅底（状态标签等）  |
| --primary-border-soft | rgba(37,99,235,0.22) | 主色浅描边（状态标签等） |
